...
namespace DVLD_PresentationLayer.Tests
{
    public partial class frmTakeTest : Form
    {
        ...
        private clsTestTypes.enType _TestType;

        private int _TestID = -1;
        private clsTest _Test;


        public frmTakeTest(int AppointmentID, clsTestTypes.enType TestType)
        {
            InitializeComponent();
        ...
        private void btnSave_Click_1(object sender, EventArgs e)
        {
            ...
            _Test.CreatedByUserID = clsGlobalSettings.User._UserID;
