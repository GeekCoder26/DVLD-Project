...
namespace DVLD_PresentationLayer.Application.Release_Detained_License
{
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void CustomizeForm()
        {
            ...
            statusStrip1.BackColor = Color.FromArgb(240, 245, 255);

            // تنسيق عام لل datagridview 
            dgvDetainedLicenses.BorderStyle = BorderStyle.None;
            dgvDetainedLicenses.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(240, 240, 240);
            ...
            dgvDetainedLicenses.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(60, 120, 200);
            dgvDetainedLicenses.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            dgvDetainedLicenses.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI Semibold", 10);
            dgvDetainedLicenses.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            // ضبط ارتفاع الرأس والصفوف
            dgvDetainedLicenses.ColumnHeadersHeight = 35;
            dgvDetainedLicenses.RowTemplate.Height = 30;
            ...
            // تحسين المظهر العام
            dgvDetainedLicenses.BackgroundColor = Color.WhiteSmoke;
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            Records.Text = $"  # Records: {dgvDetainedLicenses.Rows.Count} ";
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            Records.Text = $"  # Records: {_dtDetainedLicenses.Rows.Count} ";
